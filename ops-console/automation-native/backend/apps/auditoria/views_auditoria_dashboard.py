...
from apps.auditoria.services.auditoria_dashboard import build_auditoria_dashboard


class AuditoriaDashboardView(APIView):
    ...
    def get(self, request):
        ...
        payload = build_auditoria_dashboard(start_date=start_date, end_date=end_date)
